...
int main() {
	...
	//std::string input;
	int vipLevel = 0;
	double buyFeeRate = 0.0010; //starting aug 8 2025 lowered fee from 0.25% to 0.10% VIP 0
	double sellFeeRate = 0.0010; //starting aug 8 2025 lowered fee from 0.25% to 0.10% VIP 0
	...
	std::cout << "VIP 0: Maker 0.10%\n";
	std::cout << "VIP 1: Maker 0.09%\n";
	std::cout << "VIP 2: Maker 0.08%\n";
	std::cout << "VIP 3: Maker 0.07%\n";
	std::cout << "VIP 4: Maker 0.06%\n";
	std::cout << "VIP 5: Maker 0.05%\n";
	std::cout << "VIP 6: Maker 0.05%\n";
	std::cout << "VIP 7: Maker 0.04%\n";
	std::cout << "VIP 8: Maker 0.04%\n";
	std::cout << "VIP 9: Maker 0.03%\n";
	...
	if (input == "custom" || input == "Custom" || input == "CUSTOM") {
	    ...
	    // starting aug 8 2025 decrease in fee previous fee rate double makerRates[] = {0.0025, 0.0022, 0.0018, 0.0015, 0.0012, 0.0010, 0.0008, 0.0007, 0.0006, 0.0005};
	    double makerRates[] = {0.0010, 0.0009, 0.0008, 0.0007, 0.0006, 0.0005, 0.0005, 0.0004, 0.0004, 0.0003};
